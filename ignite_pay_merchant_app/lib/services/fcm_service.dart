...
import 'package:ignite_pay_merchant/firebase_options.dart';
...
class FcmService {
  ...
  Future<void> initialize({OnSignalReceived? onSignalReceived}) async {
    ...
    const channel = AndroidNotificationChannel(
      'ignite_pay_merchant_signals',
      'Ignite Pay Merchant Signals',
  ...
  void _showLocalNotification(String msgId) {
    const androidDetails = AndroidNotificationDetails(
      'ignite_pay_merchant_signals',
      'Ignite Pay Merchant Signals',
      channelDescription: 'Payment confirmation notifications',
      importance: Importance.high,
